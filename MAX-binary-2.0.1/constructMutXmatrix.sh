...
# Index
/cfs/klemming/projects/snic/snic2020-6-4/Meghana/MAX-binary-2.0.1/bin/TxIndexer -t WT_Mut_Ref/WT_Mut_reference.fa -o Index_reference -k $kmer --force -p $CPUNUM 
...
/cfs/klemming/projects/snic/snic2020-6-4/Meghana/MAX-binary-2.0.1/bin/simx_pair WT_Mut_Ref -o xSimDat -t $CPUNUM -d 20
